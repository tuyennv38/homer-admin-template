...
function formsCtrl($scope) {
    ...
    // $scope.people = [
		...
		// { name: 'Hồ chí minh',      email: 'adam@email.com',      age: 10 },
		// { name: 'Hà Nội',      email: 'adam@email.com',      age: 10 },
		// { name: 'Hoàng mai',      email: 'adam@email.com',      age: 10 },
		// { name: 'Cầu giấy',      email: 'adam@email.com',      age: 10 },
    // ];
$scope.people = [
"Ba Đình",
"Hoàn Kiếm",
